 ...
 * It allows user to input a right email address
 * and sent whole travel claim
 */
...
public class EmailTClaimActivity extends Activity {
	...
	public void sendEmail(View v) {
		...
		while (i < addr.length()) {
			...
			// if the email address contains @ and . character, 
			//the application considers it as legal.
			if (addr.charAt(i) == '@') {
				countAt++;
			}
			if (addr.charAt(i) == '.') {
